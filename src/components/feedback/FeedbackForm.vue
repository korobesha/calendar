...
// import Vue from 'vue'
import ValidationInput from '@/components/feedback/ValidationInput.vue';
import ValidationSelect from '@/components/feedback/ValidationSelect.vue';
import ValidationDate from '@/components/feedback/ValidationDate.vue';
import ValidationCheckbox from '@/components/feedback/ValidationCheckbox.vue';
import ValidationTextarea from '@/components/feedback/ValidationTextarea.vue';
